...
<?php
    ...
    if ($uPermLevel >= $perm_level_admin AND $uPermLevel > $row['permLevel']) {?>
        ...
        <input name="id" type="hidden" value="<?php echo $row['id'];?>" />
          ...
          <div class="form-floating mb-3">
            <select id="floatingInput" class="form-control rounded-3" name="permlevel" placeholder="Oberstabsgeneral 17">
                <option value="4" <?php if($row['permLevel']==4) echo 'selected="selected"'; ?>>4 - Verwaltung</option>
                <option value="3" <?php if($row['permLevel']==3) echo 'selected="selected"'; ?>>3 - Personaler</option>
                <option value="2" <?php if($row['permLevel']==2) echo 'selected="selected"'; ?>>2 - Ausbilder</option>
                <option value="1" <?php if($row['permLevel']==1) echo 'selected="selected"'; ?>>1 - Mitarbeiter</option>
