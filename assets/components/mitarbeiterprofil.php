                ...
                <form name="form" method="post" action="">
                  ...
                  <div class="form-floating mb-3">
                    <select id="floatingInput" class="form-control rounded-3" name="dienstgrad" placeholder="Oberstabsgeneral 17">
                      <option value="70" <?php if ($row['dienstgrad'] == "70") echo 'selected="selected"'; ?>>Geschäftsführer</option>
                      <option value="60" <?php if ($row['dienstgrad'] == "60") echo 'selected="selected"'; ?>>Vorstand</option>
                      <option value="50" <?php if ($row['dienstgrad'] == "50") echo 'selected="selected"'; ?>>Straßenmeister</option>
                      <option value="40" <?php if ($row['dienstgrad'] == "40") echo 'selected="selected"'; ?>>Kolonnenführer</option>
                      <option value="30" <?php if ($row['dienstgrad'] == "30") echo 'selected="selected"'; ?>>Verkehrswärter</option>
                      <option value="20" <?php if ($row['dienstgrad'] == "20") echo 'selected="selected"'; ?>>Straßenwärter</option>
                      <option value="10" <?php if ($row['dienstgrad'] == "10") echo 'selected="selected"'; ?>>Auszubildender</option>
                      <option value="0" <?php if ($row['dienstgrad'] == "0") echo 'selected="selected"'; ?>>Praktikant</option>
                    </select>
                  ...
                  <div class="accordion-body">
                    ...
                    if ($rowamount == 0) {
                      ...
                      while ($eintrag = mysqli_fetch_array($log)) {
                        ...
                        if ($eintrag['newRank'] == 0) {
                          // Praktikant
                          $ndienstgrad_kt = "Praktikant";
                        } elseif ($eintrag['newRank'] == 10) {
                          // Auszubildender
                          $ndienstgrad_kt = "Auszubildender";
                        } elseif ($eintrag['newRank'] == 20) {
                          // Straßenwärter
                          $ndienstgrad_kt = "Straßenwärter";
                        } elseif ($eintrag['newRank'] == 30) {
                          // Verkehrswärter
                          $ndienstgrad_kt = "Verkehrswärter";
                        } elseif ($eintrag['newRank'] == 40) {
                          // Kolonnenführer
                          $ndienstgrad_kt = "Kolonnenführer";
                        } elseif ($eintrag['newRank'] == 50) {
                          // Straßenmeister
                          $ndienstgrad_kt = "Straßenmeister";
                        } elseif ($eintrag['newRank'] == 60) {
                          // Vorstand
                          $ndienstgrad_kt = "Vorstand";
                        } elseif ($eintrag['newRank'] == 70) {
                          // Geschäftsführer
                          $ndienstgrad_kt = "Geschäftsführer";
                        } else {
                          $ndienstgrad_kt = "";
                        }
