            ...
            <div class="row">
              <div class="col">
                ...
                <div class="form-check form-switch">
                  ...
                  <label class="form-check-label" for="flexSwitchCheckDefault">Ich bestätige, dass ich all dies gelesen habe und in meiner Bewerbung so umsetze.</label>
                </div>
              </div>
              <div class="col">
                ...
                <ul>
                  ...
                  <li>Einen Führerschein der Klasse B (PKW) sowie C1 (Kleintransporter).</li>
      ...
      <?php } else { ?>
        ...
        <div class="container bg-light shadow p-3 mb-5 rounded-3 my-5" style="min-height:450px;">
          ...
          while ($row = mysqli_fetch_array($bwnr)) { ?>
            ...
            <table class="table table-bordered" id="apply-status">
              <thead>
